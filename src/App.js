                ...
                <section className="main__zone">
                  <div className="main__zone__1">
                    ...
                    <div className="main__zone__1__text__1">
                      ...
                      <p>
                        ...
                        elit. Esse corporis quasi quas, ea repellat cumque iste
                        optio autem maiores ex repudiandae sint asperiores
                        repellendus vitae temporibus minus culpa eligendi
                        praesentium aspernatur nam. Eaque, maxime numquam.
                        Provident nostrum tempore eos voluptates qui ipsa
                        adipisci aut itaque minus! Lorem ipsum dolor sit amet
                        consectetur, adipisicing elit. Esse corporis quasi quas,
                        ea repellat cumque iste optio autem maiores ex
                        repudiandae sint asperiores repellendus vitae temporibus
                        minus culpa eligendi praesentium aspernatur nam. Eaque,
                        maxime numquam. Provident nostrum tempore eos voluptates
                        qui ipsa adipisci aut itaque minus!
                      </p>
                  ...
                  <div className="main__zone__2">
                    ...
                    <div className="main__zone__2__text">
                      ...
                      <p>
                        Ми розуміємо що у дітей є багато справ як в школі, так і
                        після школи. Обирайте зручний графік самостійно
                      </p>
                  ...
                  <div className="main__zone__3">
                    ...
                    <div className="main__zone__3__text">
                      ...
                      <p>
                        ...
                        підібрати для студента комфортну групу. А як зрозуміти
                        що група вам підходить? Все просто - пройти тестування
                        та прийти на безкоштовне заняття. Заодно зможете оцінити
                        наше місцезнаходження та викладача
                      </p>
                  ...
                  <div className="main__zone__4">
                    ...
                    <div className="main__zone__4__text">
                      ...
                      <p>
                        ...
                        пристосуватися до нового середовища. Тому в нашій
                        команді, кожен вчитель виконує важливу місію старшого
                        наставника та мудрого керівника. Заняття в ігровій та
                        комунікативній формі сприяють швидкому засвоєнню
                        пройденного матеріалу та утворенню командного духу
                        групи.
                      </p>
